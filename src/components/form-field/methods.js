...
export class FormFieldMethods extends Component {
                ...
                <div className="exampleContent">
                    <div className="method">
                        ...
                        <div className="methodParams">
                            ...
                            <p className="subMethodParams">Value should be string and Options as object <span className="highlightCode">{'{ onlySelf: true | false ,emitEvent: true | false}'}</span>.</p>
                        </div>
                        <div className="methodUse">
                            Use - It is use for set value in the field.
                        </div>
                    </div>
                    <div className="method">
                        <div className="methodName">
