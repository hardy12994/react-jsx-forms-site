...
export class FormArrayMethods extends Component {
                ...
                <div className="exampleContent">
                    <div className="method">
                        ...
                        <div className="methodParams">
                            ...
                            <p className="subMethodParams">Value should be Array and Options as object <span className="highlightCode">{'{ emitEvent: true | false }'}</span>.</p>
                        </div>
                        <div className="methodUse">
                            Use - Value should be exact shadow of the value present in form array.
                        </div>
                    </div>
                    <div className="method">
                        <div className="methodName">
                        ...
                        <div className="methodParams">
                            Params - <span className="highlightCode">New Field, Options</span>
                            <p className="subMethodParams">New Field should be type of form-field or form-group or form-array and Options as object <span className="highlightCode">{'{ emitEvent: true | false }'}</span>.</p>
                        </div>
                        <div className="methodUse">
                            Use - New Field will push at the last index of fields[] in form-array.
                        </div>
                    </div>
                    <div className="method">
                        <div className="methodName">
                        ...
                        <div className="methodParams">
                            Params - <span className="highlightCode">New Field, Index, Options</span>
                            <p className="subMethodParams">New Field should be type of form-field or form-group or form-array, index as number and Options as object <span className="highlightCode">{'{ emitEvent: true | false }'}</span>.</p>
                        </div>
                        <div className="methodUse">
                            Use - New Field will push at provided index of fields[] in form-array.
                        </div>
                    </div>
                    <div className="method">
                        <div className="methodName">
                        ...
                        <div className="methodParams">
                            Params - <span className="highlightCode">Options</span>
                            <p className="subMethodParams">Options as object <span className="highlightCode">{'{ emitEvent: true | false }'}</span>.</p>
                        </div>
                        <div className="methodUse">
                            Use - It will remove your last field from the collection of form-array fields.
                        </div>
                    </div>
                    <div className="method">
                        <div className="methodName">
                        ...
                        <div className="methodParams">
                            Params - <span className="highlightCode">Index, Options</span>
                            <p className="subMethodParams">Index as number, Options as object <span className="highlightCode">{'{ emitEvent: true | false }'}</span>.</p>
                        </div>
                        <div className="methodUse">
                            Use - It will remove your field from the collection of form-array fields from provided index.
                        </div>
                    </div>
                    <div className="method">
                        <div className="methodName">
